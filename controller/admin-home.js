...
function getAdminHomeHTML (req, res) {
 
  res.statusCode = 200
  var data = fs.readFileSync('./views/admin-home.html', 'utf8');
...
function getAdminHomeCSS1 (req, res) {
  var data2 = fs.readFileSync('./views/styles/admin-home.css', 'utf8');
  res.setHeader('Content-Type', 'text/css')
  res.write(data2)
  res.end()
}

function getAdminHomeCSS2 (req, res) {
...
function getAdminHomeJS (req, res) {
...
module.exports = { getAdminHomeHTML, getAdminHomeCSS1,getAdminHomeCSS2, getAdminHomeJS, exempleAPI}
